...
private:
	...
	int       Orient2D(const Point2D &a, const Point2D &b, const Point2D &c) const;
	gfx_float Orient2D(const Point2D &a, const Point2D &b, const wide_Point2D &c) const;
...
public:
	...
	void FillTriangle(const Point2D &a, const Point2D &b, const Point2D &c, const mmlVector<var> &a_attr, const mmlVector<var> &b_attr, const mmlVector<var> &c_attr, const mmlVector<cnst> &const_attr);

	template < int var >
	void FillTriangle(const Point2D &a, const Point2D &b, const Point2D &c, const mmlVector<var> &a_attr, const mmlVector<var> &b_attr, const mmlVector<var> &c_attr);

	template < int cnst >
	void FillTriangle(const Point2D &a, const Point2D &b, const Point2D &c, const mmlVector<cnst> &const_attr);

	void FillTriangle(const Point2D &a, const Point2D &b, const Point2D &c);
};

template < int var, int cnst >
void Rasterizer::FillTriangle(const Point2D &a, const Point2D &b, const Point2D &c, const mmlVector<var> &a_attr, const mmlVector<var> &b_attr, const mmlVector<var> &c_attr, const mmlVector<cnst> &const_attr)
{
	// TODO
...
template < int var >
void Rasterizer::FillTriangle(const Point2D &a, const Point2D &b, const Point2D &c, const mmlVector<var> &a_attr, const mmlVector<var> &b_attr, const mmlVector<var> &c_attr)
{
...
template < int cnst >
void Rasterizer::FillTriangle(const Point2D &a, const Point2D &b, const Point2D &c, const mmlVector<cnst> &const_attr)
{
